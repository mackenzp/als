...
/*=== mapperCore.c =============================================================*/
extern int             Map_Mapping( Map_Man_t * p ,int *bitErrors);
/*=== mapperLib.c =============================================================*/
...
/*=== mapperTable.c =============================================================*/
extern Map_Super_t *   Map_SuperTableLookupC( Map_SuperLib_t * pLib, unsigned uTruth[], char nLeaves ,int bitError);
/*=== mapperTime.c =============================================================*/
/*=== mapperUtil.c =============================================================*/
