...
static void Map_TruthsCut( Map_Man_t * pMan, Map_Cut_t * pCut ,int bitError);
...
***********************************************************************/
void Map_MappingTruths( Map_Man_t * pMan,int* bitErrors)
{
    ...
    for ( i = 0; i < nNodes; i++ )
    {
        ...
        for ( pCut = pNode->pCuts->pNext; pCut; pCut = pCut->pNext )
             Map_TruthsCut( pMan, pCut, bitErrors[i-(pMan->nInputs)] );
...
***********************************************************************/
void Map_TruthsCut( Map_Man_t * p, Map_Cut_t * pCut,int bitError )
{ 
...
*/
        ...
        Map_CanonComputeSlow( p->uTruths, p->nVarsMax, pCut->nLeaves, uTruth, uPhases, uCanon );
    pCut->M[1].pSupers = Map_SuperTableLookupC( p->pSuperLib, uCanon, pCut->nLeaves, bitError);
...
*/
        ...
        Map_CanonComputeSlow( p->uTruths, p->nVarsMax, pCut->nLeaves, uTruth, uPhases, uCanon );
    pCut->M[0].pSupers = Map_SuperTableLookupC( p->pSuperLib, uCanon, pCut->nLeaves, bitError );
